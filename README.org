...
- create a crontab entry which runs params.sh, which is generated in https://github.com/tdhock/data.table-revdeps/blob/master/params.R#L319 (this is what we do
  currently).
